...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  'thauvin': {
	    ...
	    brief_mobile: 'Nous avons développé le site de Florian Thauvin dans l’objectif de fédérer ses centaines de milliers de fans et de développer son image. Le but était de concevoir un site visuel, interractif et responsive mobile tout en ayant une richesse de contenus. Sur ce site, les visiteurs pourront ainsi retrouver les comptes officiels de Florian Thauvin.<br/><br/>Ils auront également accès à sa fiche sportive tout comme à ses statistiques saison par saison. Une page est aussi réservée pour mettre en avant les sponsors de Florian Thauvin. Enfin pour une dimension de proximité, il y a une section réservée à ses photos Instagram.',
	  },
	  ...
	  'st-maximin': {
	    ...
	    brief_mobile: 'Nous avons développé le site d’Allan Saint-Maximin pour améliorer sa visibilité et fédérer sa communauté de fans. Il y avait une volonté de développer un site interractif et responsive mobile comme de nombreux fans utilisent leur smartphone pour aller sur internet. Le tout, en respectant un cahier des charges spécifiques concernant son image.<br/><br/>Le but est d’ancrer l’idée qu’Allan Saint-Maximin est un feu follet, à savoir un grand dribbleur, rapide et efficace. En plus de cela, l’idée était de mettre en avant ses comptes officiels ainsi que sa fiche sportive. Enfin pour renforcer les liens avec ses fans, nous mettons en avant une section dédiée à ses photos Instagram.',
	  },
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  en: {
	    home: {
	      subtitle: '<span>We guide high-level athletes in</span><span>the development of their online</span><span>presence and their community</span>'
	    },
	    thinking: {
	      txt: 'We believe that digital plays a key role in the world of sports. It allows athletes to develop a network, to build a strong image and market their achievements. These factors, often underestimated, are undoubtedly essential in order to emphasize the value of an athlete, help them getting better contracts or sponsorhips, and to enable them to find success in further projects.',
	      quote: '<span>The name of</span><span>a great athlete</span><span>is a brand and</span><span>as such it must</span><span>be protected</span><span>and developped</span><span>digitally.</span>',
	      quoteRaw: '\"The name of a great athlete is a brand and as such it must be protected and developped digitally.\"',
	    },
	    us: {
	      quote: '<span>We strive everyday to make great athletes become</span><span>idols. We create the heroes of tomorrow.</span>',
	      quoteRaw: '<span>We strive everyday to make great athletes become idols. We create the heroes of tomorrow.</span>',
	      txt: 'We are a passionate and reliable team whose dedication is limitless. We constantly question the status quo because we are innovative and detail oriented. We have received praise from our clients thanks to our aptitude to exceed the traditional role of an agency, that allows us to be a real partner throughout their career.'
	    },
	    skills: {
	      ui: 'Building responsive web apps<br/>and interactive websites',
	      identity: 'Creation of logos, designs<br/>and graphic identity',
	      content: 'Creation of GIFs, filters<br/>and photo collages',
	    }
	  },
